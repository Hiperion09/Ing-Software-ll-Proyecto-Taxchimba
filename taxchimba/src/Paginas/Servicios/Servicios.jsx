...
const Servicios = () => {
  ...
  useEffect(() => {
    const lugaresFiltrados = sitioInteres.filter(
      (sitio) => sitio.rating > calificacion
    );
  ...
  useEffect(() => {
    ...
    getPlacesData(tipo, limites.sw, limites.ne).then((data) => {
      console.log(data);
  ...
  return usuario.usuario.tipo === 2 ? (
    <Prestador tipoUsuario={usuario.usuario.tipo} />
  ) : usuario.usuario.tipo === 3 ? (
    <Admin tipoUsuario={usuario.usuario.tipo}/>
  ) : (
    <div id="prestador-container">
      <Appbar tipoUsuario={usuario.usuario.tipo} />
      <div id="viewport">
        <div id="sidebar">
          <header>
            <Link to="/">
          ...
          <div className="nav">
            <div className="switch-servicio">
              ...
              <div className="btn-enviar">
                <button
                  ...
                  onClick={() => handleClick(destino, origen, precio, usuario)}
                >
                  {" "}
                  Enviar{" "}
                </button>
            ...
            <div className="localizaciones">
              <ul>
                <SitiosInteres
                  sitioInteres={
                    sitiosFilrados.length ? sitiosFilrados : sitioInteres
                  }
                  tipo={tipo}
                  setTipo={setTipo}
      ...
      {modal && (
        <div className="modal">
          ...
          <div className="modal-content">
            <h2 className="modal-text">Solicitud Exitosa!!!</h2>
            <p>
              Tu solicitud ha sido exitosa, espera a que un prestador de servicio 
              acepte tu solicitud, cierra esta ventana para continuar.
            </p>
